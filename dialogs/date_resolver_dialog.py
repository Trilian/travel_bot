...
class DateResolverDialogStartDate(CancelAndHelpDialog):
    ...
    def __init__(
        ...
        super(DateResolverDialogStartDate, self).__init__(
            dialog_id or DateResolverDialogStartDate.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, DateResolverDialogStartDate.datetime_prompt_validator
        )
...
class DateResolverDialogEndDate(CancelAndHelpDialog):
    """Resolve the date"""
    ...
    def __init__(
        ...
        super(DateResolverDialogEndDate, self).__init__(
            dialog_id or DateResolverDialogEndDate.__name__, telemetry_client
        )
        self.telemetry_client = telemetry_client

        date_time_prompt = DateTimePrompt(
            DateTimePrompt.__name__, DateResolverDialogEndDate.datetime_prompt_validator
        )
        date_time_prompt.telemetry_client = telemetry_client
    ...
    async def initial_step(
        ...
        prompt_msg = "To what date would you like to travel?"
        reprompt_msg = (
            "I'm sorry, for best results, please enter your travel "
            "date including the month, day and year."
        )
